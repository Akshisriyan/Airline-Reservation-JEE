    ...
    <style>
        ...
        * {
        ...
        .container {
            ...
            width: 800px;
            padding: 30px;
            background-color: #4d4c6a85!important;
        }
        
        .card.box1 {
            width: 350px;
            height: 500px;
            background-color: #070549!important;
            color: #f7fdff;
            border-radius: 0
        }
